<nav class="sidebar">
    ...
    <ul class="menu">
        ...
        <li>
            <a href="#bluemess">
                <img src="{{ asset('pictures/message.png') }}" alt="Messages" class="w-6 h-6 inline mr-2"> BLUEMESS
            </a>
        </li>
        <li>
        ...
        <li class="profile">
            <a href="{{ route('account.show') }}">
                <img src="{{ Auth::user()->profile_photo_path ? (\Illuminate\Support\Str::startsWith(Auth::user()->profile_photo_path, 'http') ? Auth::user()->profile_photo_path : asset('storage/' . Auth::user()->profile_photo_path)) : asset('pictures/pop.png') }}"
                     alt="Photo de profil"
