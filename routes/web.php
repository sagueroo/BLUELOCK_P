...
Route::post('/clubs/toggle/{id}', [\App\Http\Controllers\ClubController::class, 'toggle'])->name('clubs.toggle');
// web.php
...
Route::get('/clubs', [TeamController::class, 'index'])->name('teams.index');
